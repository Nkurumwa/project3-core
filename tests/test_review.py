...
def setUp(self):
        self.user_moringa = User(username = 'Moringa',password = 'ishmael', email = 'nkurumwa@ms.com')
        self.new_review = Review(pitch_id=12345,pitch_title='Review for pitch',image_path="https://image.tmdb.org/t/p/w500/jdjdjdjn",pitch_review='This pitch is the best thing since sliced bread',user = self.user_Moringa )
